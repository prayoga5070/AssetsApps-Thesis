        ...
        <div class="card card-primary">
          ...
          <form action="<?php base_url(); ?>post" method="post" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <div class="input-group">
                    <input type="radio" name="myradio" value="1" >&nbsp; Menu &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="myradio" value="2" >&nbsp; Sub Menu &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  </div>
              ...
              <div class="form-group">
                <label>Route</label>
                <input type="text" name="route" class="form-control" placeholder="Input Route Menu">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <div class="input-group">
                    <input type="radio" name="myradio2" value="1" >&nbsp; True &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="myradio2" value="0" >&nbsp; False &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  </div>
