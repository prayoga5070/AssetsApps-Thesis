<div class="content-body">
    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <a href="<?php echo base_url(); ?>superadmin/manage/access"><button type="button" class="btn mb-1 btn-outline-dark">
                ...
                <div class="card">
                    <div class="card-body">    
                        ...
                        <div class="form-validation">
                            <form class="form-valide" action="<?php echo base_url('superadmin/manage/post_access'); ?>" method="post" enctype="multipart/form-data">
