...
<head>
    ...
    <title>Error 404 - Website Under Maintanance</title>
    <!-- Favicon icon -->
                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center pt-5">
                                <h1 class="error-text text-primary"></h1>
                                <h4 class="mt-4">Sorry For Trouble</h4>
                                <img src="<?= base_url(); ?>assets/images/error.jpg" class="img-responsive">
                                ...
                                <div class="text-center">
                                    <p>©2022 PT Mitra Kiara Indonesia</p>
                                </div>
                            </div>
                        </div>
                    </div>
